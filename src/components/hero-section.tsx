          ...
          <div className="relative w-full pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h1"
                  className="mt-5 text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem]"
                >
                  {t("hero.title")}
                </TextEffect>
                <TextEffect
            ...
            >
              <div className="relative  mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                <div
                  aria-hidden
                  className="bg-linear-to-b to-background relative inset-0 z-10 from-transparent from-35%"
                />
