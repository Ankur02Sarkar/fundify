...
export default function ServicesSection() {
  ...
  return (
    <section className="py-12 md:py-24 px-4 sm:px-6 md:px-8 lg:px-16 bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-950/20 dark:via-background dark:to-blue-900/20">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-center mb-10 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-800 bg-clip-text text-transparent leading-tight">
          {services.title}
        </h2>
